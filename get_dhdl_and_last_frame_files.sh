...
for d in l_*[0-9]/ ; do
    ...
    echo 13 17 |trjconv_d -f md${REPLICATE}_${MAXSTEP}.xtc -s md${REPLICATE}_${MAXSTEP}.tpr -o ../last_frames/md${REPLICATE}_${MAXSTEP}_l_${LAMBDA_NAME}_${LAST_FRAME} -dump ${LAST_FRAME} -center -ur compact -pbc mol
    cd ../
done